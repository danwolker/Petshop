...
export default function BenefitsSection() {
    return (
        <section className="grid grid-cols-1 gap-4 px-4 py-8 mt-6 bg-white sm:grid-cols-3">
            <Link to="/produtos" className="flex items-center gap-4 p-4 transition rounded-lg shadow bg-pink-50 hover:shadow-md">
            ...
            <Link to="/compras-programadas" className="flex items-center gap-4 p-4 transition rounded-lg shadow bg-pink-50 hover:shadow-md">
            ...
            <Link to="/servicos-pet" className="flex items-center gap-4 p-4 transition rounded-lg shadow bg-pink-50 hover:shadow-md">
