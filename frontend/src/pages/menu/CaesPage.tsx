...
export default function CasaPage({ products, addProductToCart }: Props) {
    ...
    return (
        <div className="px-4 space-y-6 sm:px-6 lg:px-8 ">
            <CategoryBar />
            <DeliveryBanner />
            <h1 className="mb-2 text-2xl font-bold text-center text-purple-800">Produtos para Cães</h1>
            <p className="mb-4 text-center text-gray-700">
                aqui você encontra tudo para o seu cão, desde ração até brinquedos e acessórios.
            </p>
