...
export default function TodosPage({ products, addProductToCart }: Props) {
    ...
    return (
        <div className="px-4 space-y-6 sm:px-6 lg:px-8">
            <CategoryBar />
            <DeliveryBanner />
            <h1 className="mb-2 text-2xl font-bold text-center text-purple-800">Todos os Produtos</h1>
            <p className="mb-4 text-center text-gray-700">
                Aqui você encontra todos os produtos disponíveis na nossa loja.
            </p>
